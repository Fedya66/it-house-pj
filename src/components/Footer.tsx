...
import { Code, GraduationCap, MapPin, Phone, Mail, Instagram, Send, Heart, ExternalLink } from 'lucide-react';
  ...
  const handleContactClick = (type: string, value: string) => {
    switch(type) {
      ...
      case 'map':
        ...
        window.open(`https://www.google.com/maps/place/IT+HOUSE/@41.2858225,69.1860677,17z/data=!3m1!4b1!4m6!3m5!1s0x38ae89ade0861433:0xa6470d048143a930!8m2!3d41.2858225!4d69.1860677!16s%2Fg%2F11rs06tlg2?entry=ttu&g_ep=EgoyMDI1MDYyNi4wIKXMDSoASAFQAw%3D%3D=${encodedAddress}`, '_blank');
        break;
    }
  };
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <span className="text-2xl font-bold tracking-tight">IT HOUSE</span>
            </button>
            
            <p className="text-slate-400 leading-relaxed mb-6 max-w-md">
              Zamonaviy IT sohasida professional mutaxassislar tayyorlashga ixtisoslashgan ta'lim markazi. 
              Bizning maqsadimiz - har bir o'quvchini muvaffaqiyatli karyeraga tayyorlash.
            </p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="text-slate-400 text-sm">
                  <button 
                    onClick={() => handleContactClick('email', 'info@itschool.uz')}
                    className="block hover:text-red-400 transition-colors"
                  >
        ...
        <div className="py-8 border-t border-slate-800">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {[
              ...
              >
                <span className="text-slate-300 hover:text-white text-sm">{course}</span>
              </button>
            ))}
          </div>
        </div>
        ...
        <div className="py-8 border-t border-slate-800">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-slate-400 text-sm">bilan</span>
            </div>
          </div>
        </div>
      </div>
